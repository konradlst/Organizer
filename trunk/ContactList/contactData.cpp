...
void ContactData::setAddressData(const QString &type, const QString &data, const int &index)
{
...
void ContactData::setCompanyData(const QString &type, const QString &data, const int &index)
{
...
void ContactData::setCompanyData(const QString &type, const QDate &data, const int &index)
{
    Company::Data *temp = new Company::Data;
